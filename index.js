...
/*Task 1: counterMaker()
  ...
  Counter1 reset to 0 every time when it is called where as counter2 keeps memory of data and can be called multiple times. 
  
  2. Which of the two uses a closure? How can you tell?
   Both, they both have access to the same scope in the outer function.

  3. In what scenario would the counter1 code be preferable? In what scenario would 
     counter2 be better?  
   Counter1 count scope is local; counter2 has access to count as it's global.
*/
